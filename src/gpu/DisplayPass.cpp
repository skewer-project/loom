...
void DisplayPass::record(VkCommandBuffer cmd, VkImage hdrImage, VkImage dstImage,
                         ...
                         uint32_t bindlessSlot, uint32_t width, uint32_t height, uint32_t srcWidth,
                         uint32_t srcHeight, uint32_t toneMapMode, uint32_t displayTransform,
                         float exposure) {
    ...
    PushConstants pc{bindlessSlot, width,       height,           srcWidth,
                     srcHeight,    toneMapMode, displayTransform, exposure};
